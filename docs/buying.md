...
A blank or malformed domain list reads as **unset**, meaning no restriction, never as an
...
- **`WAYFARER_MIN_VALIDITY_SECONDS`** (default `60`) is a floor on the buyer's EIP-3009
